...
- [OpenWeatherMap](https://openweathermap.org/api) — `WEATHER_API_KEY` (бесплатно)
...
<br>##<br> 🤝 Лицензия<br> MIT License — свободное использование и модификация. **Made with ❤️ for Telegram**
